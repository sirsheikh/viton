...
class AlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):        
        ...
        im_name='dataset/test_img/edgemen.jpg'
        c_name='dataset/test_clothes/dress.jpg'

        I_path = im_name#os.path.join(self.dir_I,im_name)
        ...
        C_path = c_name# os.path.join(self.dir_C,c_name)
        C = Image.open(C_path).convert('RGB')
        C_tensor = transform(C)

        E_path = 'dataset/test_edge/dressEdge.jpg' #os.path.join(self.dir_E,c_name)
